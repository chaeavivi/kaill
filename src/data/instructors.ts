...
export const instructors: Instructor[] = [
  ...
  },
  {
    ...
    bio: 'ChatGPT 3.5 출시(2022년)부터 활용해 온 1세대 AI 교육 강사. 강의 경력 18년 이상. 생성형 AI 활용부터 강사 브랜딩·콘텐츠 마케팅까지 폭넓게 다룹니다. 원주채아힐링센터 대표 · 컬러웰니스협회 협회장.',
    records: ['삼성SDI', '네이버파이낸셜', '넥슨코리아', '무신사', '제주항공'],
  },
];
